...
- [ ] After manual validation, merge the release branch to `master`, create tag `1.0.6`, push, and publish the four release assets.
...
- Verify next: After local manual checks, merge and tag `release/v1.0.6`; after publishing, exercise the real installed 1.0.5 automatic-update path.
